...
% Define a high-pass filter (circular mask)
...
savePath = fullfile(pathname, 'somesh_highscale.jpeg');
...
subplot(1, 3, 3), imshow(img_filtered), title('High-Pass Filtered Image');

disp('High-pass filtering applied successfully.');
